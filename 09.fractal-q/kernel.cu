...
__global__ void julia_kernel(double centro_real, double centro_img,
                             int num_interaciones, double x_min, double y_min, double x_max,
...
void julia_gpu(
    double centro_real, double centro_img,

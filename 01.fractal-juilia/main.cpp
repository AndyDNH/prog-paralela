...
#pragma omp master
    ...
    std::string options = "Options: [1]Serial_1 [2]Serial_2 [3]SIMD [4]OpenMP [5]OpenMP_FOR [6]OpenMP_FOR_SIMD | UP/DOWN : Change Iterations";

...
std::complex<double> c(-0.7,0.027015);
//Indica que la funcion va a ser compiilada con c
//los tipos de datos tiene que ser standar, datos como complex son de c++ no son compatibles con otros lenguajes
extern "C" __stdcall
void julia_simd(double x_min, double y_min, double x_max, double y_max, uint32_t width,uint32_t height,int max_iteraciones ,uint32_t* pixel_buffer){
